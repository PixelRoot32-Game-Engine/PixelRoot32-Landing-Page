...
export const i18n = new I18nStore({
  en: {
    ...
    'builtwith.spaceinvaders.description': 'Classic arcade shooter demonstrating 1bpp sprites, audio, collisions, and entity management with NES color palette.',
    'builtwith.brickbreaker': 'BrickBreaker',
    'builtwith.brickbreaker.description': 'Breakout-style game featuring physics-based collisions, particle effects, and Atari-style audio with GBC color palette.',
    'builtwith.tictactoe': 'Tic-Tac-Toe',
    'builtwith.tictactoe.description': 'Turn-based game with AI opponent showcasing custom neon palette usage and state management.',
  ...
  es: {
    ...
    'builtwith.spaceinvaders': 'Space Invaders',
    'builtwith.spaceinvaders.description': 'Clásico shooter de arcade que demuestra sprites 1bpp, audio, colisiones y gestión de entidades con paleta de colores NES.',
    'builtwith.brickbreaker': 'BrickBreaker',
    'builtwith.brickbreaker.description': 'Juego estilo breakout con colisiones basadas en física, efectos de partículas y audio estilo Atari con paleta GBC.',
    'builtwith.tictactoe': 'Tres en Raya',
    'builtwith.tictactoe.description': 'Juego por turnos con oponente AI que muestra el uso de paleta neon personalizada y gestión de estado.',
