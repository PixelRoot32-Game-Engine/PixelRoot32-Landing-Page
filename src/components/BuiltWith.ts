    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="group cursor-pointer">
        <div class="bg-surface border-2 border-border-ui hover:border-primary transition-all shadow-block hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-block-hover overflow-hidden relative aspect-square">
          <img src="/build_with/bomberbot-game.webp" alt="Bomberbot Game" class="absolute inset-0 w-full h-full object-cover" />
          ...
          <div class="absolute bottom-0 left-0 right-0 p-6 bg-background/90 backdrop-blur-[2px]">
            <h3 class="text-xl font-bold mb-2 group-hover:text-primary transition-colors">${i18n.t('builtwith.bomberbot')}</h3>
            <p class="text-sm text-text-muted mb-4">${i18n.t('builtwith.bomberbot.description')}</p>
            <div class="flex items-center gap-2 text-xs text-text-muted">
              <span class="font-mono">${i18n.t('builtwith.by')}</span>
              <span>•</span>
              <a href="https://github.com/PixelRoot32-Game-Engine/PixelRoot32-Game-Engine/tree/main/examples/bomberbot" target="_blank" class="hover:text-primary transition-colors font-mono">${i18n.t('builtwith.view')}</a>
            </div>
          </div>
        </div>
      </div>

      <!-- Project 2 - Midway Clone -->
      <div class="group cursor-pointer">
        <div class="bg-surface border-2 border-border-ui hover:border-secondary transition-all shadow-block hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-block-hover overflow-hidden relative aspect-square">
          <img src="/build_with/midway_clone-game.webp" alt="Midway Clone Game" class="absolute inset-0 w-full h-full object-cover" />
          ...
          <div class="absolute bottom-0 left-0 right-0 p-6 bg-background/90 backdrop-blur-[2px]">
            <h3 class="text-xl font-bold mb-2 group-hover:text-secondary transition-colors">${i18n.t('builtwith.midway_clone')}</h3>
            <p class="text-sm text-text-muted mb-4">${i18n.t('builtwith.midway_clone.description')}</p>
            <div class="flex items-center gap-2 text-xs text-text-muted">
              <span class="font-mono">${i18n.t('builtwith.by')}</span>
              <span>•</span>
              <a href="https://github.com/PixelRoot32-Game-Engine/PixelRoot32-Game-Engine/tree/main/examples/midway_clone" target="_blank" class="hover:text-secondary transition-colors font-mono">${i18n.t('builtwith.view')}</a>
            </div>
          </div>
        </div>
      </div>

      <!-- Project 3 - Legend of Clone -->
      <div class="group cursor-pointer">
        <div class="bg-surface border-2 border-border-ui hover:border-retro transition-all shadow-block hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-block-hover overflow-hidden relative aspect-square">
          <img src="/build_with/legend_of_clone-game.webp" alt="Legend of Clone Game" class="absolute inset-0 w-full h-full object-cover" />
          ...
          <div class="absolute bottom-0 left-0 right-0 p-6 bg-background/90 backdrop-blur-[2px]">
            <h3 class="text-xl font-bold mb-2 group-hover:text-retro transition-colors">${i18n.t('builtwith.legend_of_clone')}</h3>
            <p class="text-sm text-text-muted mb-4">${i18n.t('builtwith.legend_of_clone.description')}</p>
            <div class="flex items-center gap-2 text-xs text-text-muted">
              <span class="font-mono">${i18n.t('builtwith.by')}</span>
              <span>•</span>
              <a href="https://github.com/PixelRoot32-Game-Engine/PixelRoot32-Game-Engine/tree/main/examples/legend_of_clone" target="_blank" class="hover:text-retro transition-colors font-mono">${i18n.t('builtwith.view')}</a>
            </div>
          </div>
        </div>
      </div>
