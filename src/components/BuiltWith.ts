    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="group cursor-pointer">
        <div class="bg-surface border-2 border-border-ui hover:border-primary transition-all shadow-block hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-block-hover overflow-hidden relative aspect-square">
          <img src="/build_with/spaceinvaders-game.PNG" alt="Space Invaders Game" class="absolute inset-0 w-full h-full object-cover" />
      ...
      <div class="group cursor-pointer">
        <div class="bg-surface border-2 border-border-ui hover:border-secondary transition-all shadow-block hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-block-hover overflow-hidden relative aspect-square">
          <img src="/build_with/brickbrake-game.PNG" alt="BrickBreaker Game" class="absolute inset-0 w-full h-full object-cover" />
          ...
          <div class="absolute bottom-0 left-0 right-0 p-6 bg-background/90 backdrop-blur-[2px]">
            <h3 class="text-xl font-bold mb-2 group-hover:text-secondary transition-colors">${i18n.t('builtwith.brickbreaker')}</h3>
            <p class="text-sm text-text-muted mb-4">${i18n.t('builtwith.brickbreaker.description')}</p>
            <div class="flex items-center gap-2 text-xs text-text-muted">
              <span class="font-mono">${i18n.t('builtwith.by')}</span>
              <span>•</span>
              <a href="https://github.com/PixelRoot32-Game-Engine/PixelRoot32-Game-Samples/tree/master/src/examples/Games/BrickBreaker" target="_blank" class="hover:text-secondary transition-colors font-mono">${i18n.t('builtwith.view')}</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="group cursor-pointer">
        <div class="bg-surface border-2 border-border-ui hover:border-retro transition-all shadow-block hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-block-hover overflow-hidden relative aspect-square">
          <img src="/build_with/tictactoe-game.PNG" alt="Tic-Tac-Toe Game" class="absolute inset-0 w-full h-full object-cover" />
