...
export function CTA(): string {
  ...
  <div class="max-w-4xl mx-auto px-4 text-center">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
      <a href="https://docs.pixelroot32.org" target="_blank" class="w-full sm:w-auto px-10 py-5 bg-primary text-black font-mono font-black text-xl shadow-block hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-block-hover-lg transition-all">
        ${i18n.t('cta.cta1')}
      </a>
